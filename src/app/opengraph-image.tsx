...
export const alt = 'Janes Streaming - Swipe on what to watch next'
export const size = {
  width: 1200,
  height: 630,
}
...
export default async function Image() {
  try {
    ...
    const text = "Janes Streaming Swipe on what to watch next, by yourself or together."
